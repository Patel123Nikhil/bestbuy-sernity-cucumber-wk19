Feature:BestBuy Application
  ...
  Scenario Outline: CRUD Test
    ...
    And I update a product with product Id and give information ProductId "673890" name "Johan1", type "HardGood", upc "abcd", description "auto", model "best", price  "10", shipping "11" , manufacturer "tesla"
