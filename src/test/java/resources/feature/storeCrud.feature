Feature:BestBuy Application
  ...
  Scenario Outline: CRUD Test
    ...
    And I update a store with storeId and give information storeId "39" name "Johan", address "testing", city "southAmerica", state "Newyork", zip "we3wr", type  "abcd", address- "highway", lat "20",lng "10",hours "11:11",services "LMNO"
    ...
    Examples:
      ...
      | Johan12 | prime Testing | abcd | auto  | 102df | best | avenue   | 10  | 100 | 10:15 | tesla    |
